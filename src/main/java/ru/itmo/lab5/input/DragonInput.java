...
public class DragonInput {
     ...
     * Создает дракона
     */
    public Dragon make() throws IncorrectScriptException, InvalidFormException, InvalidValueException {
        var dragon = new Dragon(inputDragonName(), inputCoordinates(), inputAge(), inputDescription(), inputColor(), inputDragonCharacter(), inputPerson());
